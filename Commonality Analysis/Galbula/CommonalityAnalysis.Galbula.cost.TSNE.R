...
r = raster('~/AMNH/Roosevelt_Project/Niche_models/Galbula/GalbulaModel/CurrentGalbFull.tif')
rnew = r
...
pdf('Galb_CA_TSNE.pdf',width=8,height=5, bg='transparent')
tmp = resBootstrap
tmp = round(tmp,3)
tmp$n = rev(tmp$n)
...
plot(as.factor(bar2.vec),TSNE.vec,ylab="Genomic Divergence in TSNE space",xlab="", Main="Galbula")
