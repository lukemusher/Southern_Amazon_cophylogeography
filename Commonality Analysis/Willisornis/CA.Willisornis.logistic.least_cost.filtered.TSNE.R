...
#			genetic structure of Willisornis spp.
#
...
###   load barrier data
bar = read.delim('mbar.willisornis.txt', stringsAsFactors = F)
...
pdf('Willis_CA_logistic_cost_filtered_TSNE.pdf',width=8,height=5, bg='transparent')
tmp = resBootstrap
tmp = round(tmp,3)
tmp$n = rev(tmp$n)
